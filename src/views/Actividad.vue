  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9(data-aos="fade-left")
        .titulo-segundo
          h2 Desafío de competencias matemáticas
        p.mb-4 Evaluar la comprensión y aplicación de conceptos clave en competencias matemáticas avanzadas, lógica, trigonometría y estadística, mediante la resolución de problemas complejos y desafiantes.
